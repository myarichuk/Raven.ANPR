...
function(add_boost_test SOURCE_FILE_NAME DEPENDENCY_LIB)
	...
	set(TEST_EXECUTABLE_TARGET ${TEST_EXECUTABLE_NAME} CACHE STRING "")
	
	target_include_directories(${TEST_EXECUTABLE_NAME} PUBLIC ${Boost_INCLUDE_DIR} ${OpenCV_INCLUDE_DIRS} ${CMAKE_INCLUDE_PATH})
   ...
   if(${N} EQUAL 1)
	   ...
	   if(${N} EQUAL 1)
		   list(GET SUITE_MATCHES 0 SUITE_MATCH)
		   string(REGEX REPLACE ".*\\( *([A-Za-z_0-9]+) *\\)" "\\1" SUITE_NAME ${SUITE_MATCH})
	   endif()
   endif()
